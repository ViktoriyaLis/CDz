...
int[,] array = generate2DArray (4,4,0, 20);
print2DArray(array);
Console.WriteLine("--------------");
int [,] MinSumRowsElementsArray = MinSumElements(array);
print2DArray(MinSumRowsElementsArray);
Console.WriteLine($"Строка с минимальной суммой -> {MinSumRowsElementsArray+1}");
*/
